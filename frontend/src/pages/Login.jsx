import { Lock, Mail, MonitorCheck } from "lucide-react";
      ...
      <section className="relative z-10 w-full max-w-md rounded-2xl bg-white/10 p-6 shadow-[0_30px_100px_rgba(30,41,59,0.45)] ring-1 ring-white/15 backdrop-blur-xl">
        <div className="mb-7">
          ...
          <p className="mt-2 text-sm leading-6 text-slate-300">
            Sign in to view notices and manage content based on your role.
          </p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-slate-300">
          New here?{" "}
          <Link to="/register" className="font-bold text-amber-200 hover:text-amber-100">
            Create an account
          </Link>
        </p>
      </section>
